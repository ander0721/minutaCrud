...
<body>
	...
	<div class="container-agille">
		<div class="formBox level-login">
			...
			<div class="box loginBox">
                            ...
                            <center><a><img src="{{asset('web/images/v.png')}}" alt=""></a></center><br>
                            <!--<h3>Iniciar Sesión</h3>-->
                            <form method="POST" action="{{ route('login') }}">
                            @csrf
					<div class="f_row-2">
						<input type="email" class="input-field" placeholder="Usuario" name="email" required>
					</div>
					<div class="f_row-2 last">
						<input type="password" name="password" placeholder="Contraseña" class="input-field" required>
					</div>
					<input class="submit-w3" type="submit" value="Iniciar Sesión">
					<div class="f_link">
						<a href="" class="resetTag">¿Olvido su contraseña?</a>
					</div>
				</form>
			</div>
			...
			<div class="box registerBox wthree">
                ...
                @csrf
					<div class="f_row-2">
						<input type="text" class="input-field" placeholder="Usuario" name="email" required>
					</div>
					<div class="f_row-2 last">
						<input type="password" name="password" placeholder="Contraseña" id="password1" class="input-field" required>
					</div>
					<div class="f_row-2 last">
						<input type="password" name="password" placeholder="Confirmar Contraseña" id="password2" class="input-field" required>
					</div>
					<input class="submit-w3" type="submit" value="Registrar">
				</form>
			</div>
	...
	<!-- //Jquery -->
	<!-- input fields js -->
	<script src="{{asset('web/js/input-field.js')}}"></script>
	<!-- //input fields js -->
